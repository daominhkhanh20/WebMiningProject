...
from src.learner.DecisionTree import DecisionTree
...
dataset = MlDataset(
    ...
    path_valset='/home/thangnd/Documents/Project/WebMiningProject/assets/_UIT-VSFC/csv/dev.csv', mode_encoding="tfidf"
)
decision_tree = DecisionTree(model_path='/home/thangnd/Documents/Project/WebMiningProject/assets/models',
...
acc, pre, recal, f1, y_true, y_pred = decision_tree.evaluate(test_set['input'], test_set['label'])
print("Accuracy: ", acc)
print("Precision: ", pre)
print("Recall: ", recal)
print("F1 score: ", f1)
